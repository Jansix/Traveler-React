  ...
  return (
    <div className="lg:mx-10 ">
      ...
      <section className="flex items-center max-w-[1530px] lg:mx-auto 2xl:gap-20 gap-10 mb-[75px] flex-wrap lg:flex-nowrap mt-8 xl:mx-12 px-4">
        <div className="lg:w-1/2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500">
          <p className="mb-6 text-lg text-gray-500">ABOUT TRAVELER</p>
          <div className="mb-6 lg:text-4xl text-2xl">
            <h3 className="mb-4 font-bold text-TT-color">
              <span className="border-b-[1px] border-black ">你夢想中的行程。</span>
            </h3>
            <h3 className="font-bold text-TT-color mb-12">
              <span className="border-b-[1px] border-black">Traveler陪你一同打造</span>
            </h3>
          </div>
          <p className="sm:text-lg text-base leading-loose">
        ...
        <img src={img3} alt="img3" className="lg:w-1/2 w-full order-first lg:order-last" />
      </section>
      <section className=" flex flex-col items-center lg:py-8 mb-8 ">
        ...
        <div>
          <h5 className="text-4xl md:text-5xl mb-6 font-semibold border-b-2 border-gray-600">過往案例</h5>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
          <div className="shadow-lg rounded-md ring-gray-300 border-[1px] border-amber-800 hover:border-2  ">
            ...
            <p className="text-center p-8 text-2xl font-semibold">巴黎鐵塔浪漫蜜月遊</p>
          </div>
          ...
          <div className="shadow-lg rounded-md ring-gray-300 border-[1px] border-amber-800  hover:border-2">
            ...
            <p className="text-center p-8 text-2xl font-semibold">雪梨歌劇院文藝行</p>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
            <div className="bg-black bg-opacity-60 w-[300px] h-[100px] md:w-[620px] md:h-[120px] flex items-center justify-center">
              ...
              <div className="bg-white h-8 absolute bottom-0 w-full opacity-80 text-xl text-center">熱門景點x清幽秘境</div>
            </div>
          </div>
        </div>
      </section>
